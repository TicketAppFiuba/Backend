...
def test09_theTopOneIsGmoviaWithTwoAttendances():
    config.addEvent("gmovia@fi.uba.ar", "t1", "c", 100, 100, 10, 10, "published")
...
def test10_theTopOneIsGmoviaWithFiveAttendances():
    config.addEvent("gmovia@fi.uba.ar", "t1", "c", 100, 100, 10, 10, "published")
    config.addEvent("gmovia@fi.uba.ar", "t2", "c1", 100, 100, 10, 10, "published")
    ...
    config.addPermissionScan("ldefeo@fi.uba.ar", 2)
